...
The request needs to post the following form data in JSON format:
	positions = 
		'{
...
These arrays can be easily be written in ruby and converted to json using the .to_json method as follows:
...
Your code should produce an infinite string of co-ordinates for each shot of your game strategy. Each shot should be sent to the server singularly in a JSON array as follows:
...
Possible response statuses:
* 200 - Successful shot
* 500 - Error - probably because you've already lost.

This also can be created using the .to_json method using ruby:
...
That would be preferred. But I'm not your mother. If I was your mother, I might tell you to stop shooting poor defenceless badgers. If I was my mother, I would help you skin them and boil up a tasty badger soup though, so your milage may vary. 
